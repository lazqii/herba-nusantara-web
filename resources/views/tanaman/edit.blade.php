            ...
            <div class="card-body">
                <form action="{{ route('tanaman.update', $tanaman->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 border p-3 rounded">
                        ...
                        <input type="text" name="nama_ilmiah" id="nama_ilmiah" class="form-control @error('nama_ilmiah') is-invalid @enderror" value="{{ old('nama_ilmiah', $tanaman->nama_ilmiah) }}" placeholder="Contoh: Zingiber officinale">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="deskripsi" id="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" rows="3">{{ old('deskripsi', $tanaman->deskripsi) }}</textarea>
                        @error('deskripsi') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="mb-3 border p-3 rounded">
                        <label for="khasiat" class="form-label fw-bold">Manfaat / Khasiat</label>
                        <textarea name="khasiat" id="khasiat" class="form-control @error('khasiat') is-invalid @enderror" rows="3" placeholder="Pisahkan dengan koma atau baris baru">{{ old('khasiat', $tanaman->khasiat) }}</textarea>
                    ...
                    <div class="mb-3 border p-3 rounded">
                        ...
                        <textarea name="olahan" id="olahan" class="form-control @error('olahan') is-invalid @enderror" rows="3">{{ old('olahan', $tanaman->olahan) }}</textarea>
                    ...
                    <div class="mb-3 border p-3 rounded">
                        ...
                        <textarea name="efek_samping" id="efek_samping" class="form-control @error('efek_samping') is-invalid @enderror" rows="2">{{ old('efek_samping', $tanaman->efek_samping) }}</textarea>
                    ...
                    <div class="mb-3 border p-3 rounded">
                        ...
                        <input type="text" name="sumber" id="sumber" class="form-control @error('sumber') is-invalid @enderror" value="{{ old('sumber', $tanaman->sumber) }}" placeholder="Contoh: Jurnal Kesehatan 2023">
                    ...
                    <div class="mb-3">
                        ...
                        @if($tanaman->gambar)
                            <div class="mb-2">
                                ...
                                <img src="{{ Storage::url($tanaman->gambar) }}" alt="{{ $tanaman->nama_tanaman }}" class="img-thumbnail" style="max-height: 150px;">
                            </div>
                        @endif
                        <input type="file" 
                            name="gambar" 
                        ...
                        <div class="form-text">Biarkan kosong jika tidak ingin mengganti gambar. Format: JPG, PNG, GIF (Maks 2MB).</div>
                        @error('gambar')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
